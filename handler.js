...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.wm = '© ɪᴍᴠ ʙᴏᴛ'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ɪᴍᴠ ʙᴏᴛ'
        global.kontak2 = [
        ['6282252285143', 'ɪᴍᴠ ʏᴀɴɴ', 'ᴅᴇᴠᴇʟᴏᴘᴇʀ ʙᴏᴛ', 'https://chat.whatsapp.com/B9cQxA0NWrXHtFclMS5awJ', true],
        ['6282252285143', await this.getName('6282252285143@s.whatsapp.net'), '𝐢𝐦𝐯 𝐲𝐚𝐧𝐧', 'https://chat.whatsapp.com/B9cQxA0NWrXHtFclMS5awJ', true], 
        ]
